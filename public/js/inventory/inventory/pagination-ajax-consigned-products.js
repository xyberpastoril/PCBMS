class ConsignedProductsPaginationAjax {
    /**
    ...
    displayTableRows(rows) 
    {
        ...
        rows.forEach(function(row){           
            ...
            columns.forEach(function(c){
                inner += `
                    <td>${
                        c == 'unit_price' || c == 'sale_price' || c == 'inventory_value'
                        ? '₱ '
                        : ''    
                    }${row[c]}${
        ...
        actionsAddEventListenersConsignedProducts(this.modelName, this.ajaxUrl, this.actions);
    }
...
function processRequestConsignedProducts(request, table)
{
    ...
    request.done(function(res, status, jqXHR) {
        ...
        $(`.btn-paginate-${table.modelName}`).click(function(e) {
            ...
            processRequestConsignedProducts(request, table);
        });
    });
...
function displayActionButtonsConsignedProducts(id, uuid, modelName, actions, customActionsHtml = undefined)
{
    var inner = '';
...
function actionsAddEventListenersConsignedProducts(modelName, ajaxUrl, actions)
{
